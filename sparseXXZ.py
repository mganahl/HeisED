...
RETURNS: sparse matrix of csc_matrix type containing the Hamiltonian
"""
...
"""
calculates all non-zero matrix elements of the periodic 1d XXZ Hamiltonian 
Jz,Jxy (float): Hamiltonian parameteres
N (int): number of sites
basis (list() of uint64): a list of unit64 numbers encoding the basis-states
